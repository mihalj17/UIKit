...
//  Project8
//
//  Created by Matko Mihaljl on 16.08.2022..
//
...
class ViewController: UIViewController {
    ...
    @objc func submitTapped (_ sender : UIButton){
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText){
            ...
            if score % 7 == 0 {
                let ac = UIAlertController(title: "Well Done", message: "Are you redy for next level", preferredStyle: .alert)
                ac.addAction(UIAlertAction(title: "Lets go!", style: .default, handler: levelUp))
                present(ac, animated: true)
            }
        
        } else {
            let warning = UIAlertController(title: "Wrong answer", message: "try again", preferredStyle: .alert)
            warning.addAction(UIAlertAction(title: "Again", style: .default))
